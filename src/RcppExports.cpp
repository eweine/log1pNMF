...
// get_sparse_term_loglik_exact_parallel
double get_sparse_term_loglik_exact_parallel(const arma::mat& U_T, const arma::mat& V_T, const std::vector<int>& nonzero_y, const std::vector<int>& nonzero_y_i_idx, const std::vector<int>& nonzero_y_j_idx, const arma::vec& s);
RcppExport SEXP _passPCA_get_sparse_term_loglik_exact_parallel(SEXP U_TSEXP, SEXP V_TSEXP, SEXP nonzero_ySEXP, SEXP nonzero_y_i_idxSEXP, SEXP nonzero_y_j_idxSEXP, SEXP sSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(get_sparse_term_loglik_exact_parallel(U_T, V_T, nonzero_y, nonzero_y_i_idx, nonzero_y_j_idx, s));
    return rcpp_result_gen;
END_RCPP
}
// get_dense_term_loglik_exact_parallel
double get_dense_term_loglik_exact_parallel(const arma::mat& U_T, const arma::mat& V_T, const int n, const int p);
RcppExport SEXP _passPCA_get_dense_term_loglik_exact_parallel(SEXP U_TSEXP, SEXP V_TSEXP, SEXP nSEXP, SEXP pSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::mat& >::type U_T(U_TSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(get_dense_term_loglik_exact_parallel(U_T, V_T, n, p));
    return rcpp_result_gen;
END_RCPP
}
// get_sparse_term_loglik_quad_sparse_approx_parallel
double get_sparse_term_loglik_quad_sparse_approx_parallel(const arma::mat& U_T, const arma::mat& V_T, const std::vector<int>& nonzero_y, const std::vector<int>& nonzero_y_i_idx, const std::vector<int>& nonzero_y_j_idx, const arma::vec& s, const double a1, const double a2);
RcppExport SEXP _passPCA_get_sparse_term_loglik_quad_sparse_approx_parallel(SEXP U_TSEXP, SEXP V_TSEXP, SEXP nonzero_ySEXP, SEXP nonzero_y_i_idxSEXP, SEXP nonzero_y_j_idxSEXP, SEXP sSEXP, SEXP a1SEXP, SEXP a2SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::mat& >::type U_T(U_TSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(get_sparse_term_loglik_quad_sparse_approx_parallel(U_T, V_T, nonzero_y, nonzero_y_i_idx, nonzero_y_j_idx, s, a1, a2));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    {"_passPCA_get_sparse_term_loglik_exact_parallel", (DL_FUNC) &_passPCA_get_sparse_term_loglik_exact_parallel, 6},
    {"_passPCA_get_dense_term_loglik_exact_parallel", (DL_FUNC) &_passPCA_get_dense_term_loglik_exact_parallel, 4},
    {"_passPCA_get_sparse_term_loglik_quad_sparse_approx_parallel", (DL_FUNC) &_passPCA_get_sparse_term_loglik_quad_sparse_approx_parallel, 8},
