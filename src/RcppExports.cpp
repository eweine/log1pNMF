...
RcppExport SEXP _log1pNMF_openmp_available() {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const std::vector<int>& >::type U_update_indices(U_update_indicesSEXP);
    Rcpp::traits::input_parameter< const std::vector<int>& >::type V_update_indices(V_update_indicesSEXP);
    Rcpp::traits::input_parameter< const bool >::type verbose(verboseSEXP);
    Rcpp::traits::input_parameter< const double >::type tol(tolSEXP);
    rcpp_result_gen = Rcpp::wrap(fit_factor_model_log1p_exact_cpp_src(sc_x, sc_i, sc_j, sc_T_x, sc_T_i, sc_T_j, s, U_T, V_T, n, p, max_iter, alpha, beta, num_ccd_iter, U_update_indices, V_update_indices, verbose, tol));
    return rcpp_result_gen;
END_RCPP
}
// fit_factor_model_log1p_quad_approx_sparse_cpp_src
List fit_factor_model_log1p_quad_approx_sparse_cpp_src(const std::vector<int>& sc_x, const std::vector<int>& sc_i, const std::vector<int>& sc_j, const std::vector<int>& sc_T_x, const std::vector<int>& sc_T_i, const std::vector<int>& sc_T_j, const arma::vec& s, arma::mat& U_T, arma::mat& V_T, const double a1, const double a2, const int n, const int p, const int max_iter, const double alpha, const double beta, const int num_ccd_iter, const std::vector<int>& U_update_indices, const std::vector<int>& V_update_indices, const bool verbose, const double tol);
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const bool >::type verbose(verboseSEXP);
    Rcpp::traits::input_parameter< const double >::type tol(tolSEXP);
    rcpp_result_gen = Rcpp::wrap(fit_factor_model_log1p_quad_approx_sparse_cpp_src(sc_x, sc_i, sc_j, sc_T_x, sc_T_i, sc_T_j, s, U_T, V_T, a1, a2, n, p, max_iter, alpha, beta, num_ccd_iter, U_update_indices, V_update_indices, verbose, tol));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_log1pNMF_fit_factor_model_log1p_quad_approx_sparse_cpp_src", (DL_FUNC) &_log1pNMF_fit_factor_model_log1p_quad_approx_sparse_cpp_src, 21},
    {NULL, NULL, 0}
};

RcppExport void R_init_log1pNMF(DllInfo *dll) {
