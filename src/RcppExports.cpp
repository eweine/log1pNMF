...
arma::vec solve_pois_reg_log1p(const arma::mat& X, const arma::vec y, const arma::uvec y_nz_idx, const arma::vec& s, arma::vec b, const std::vector<int>& update_indices, int num_iter, const double alpha, const double beta);
