...
# Initialization: full rank-1 (rank-1 warm-up + 1 exact iteration).  Objective: approx.
#
...
#   Rscript exact_vs_approx_moca_rank1_plus1_approx.R > moca_rank1_plus1_approx.log 2>&1 &

source("exact_vs_approx_moca_common.R")

run_job("rank1_plus1", "approx")
