out <- readr::read_rds("/Users/eweine/Documents/data/bbc_binomial_thinning_batch1.rds")
...
res_df <- data.frame(
  cc = rep(c(0.001, 0.01, 0.1, 1, 10, 100, 1000, Inf), each = 20),
  loglik = c(
    train_ll_c_001,
    test_ll_c_001,
    train_ll_c_01,
