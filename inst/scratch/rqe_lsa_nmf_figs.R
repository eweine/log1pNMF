...
load("~/Documents/log1pNMF/inst/paper_figures/data/experiment_results.Rdata")
...
p1 <- sp1 +
  ...
  guides(colour = "none") +
  ggtitle("log1p NMF (c = 1) Cell Scores \u2014 Cell Type Associated Factors") +
  theme(
...
p2 <- sp2 +
  ...
  guides(fill=guide_legend(title="Factor", ncol=1)) +
  guides(colour = "none") +
  ggtitle("log1p NMF (c = 1) Cell Scores \u2014 Treatment Associated Factors") +
  theme(
...
p4 <- structure_plot(
  ...
  guides(fill=guide_legend(title="Factor", ncol=1))	+
  guides(colour = "none") +
  ggtitle("Standard NMF Cell Scores \u2014 Cell Type Associated Factors")	+
  theme(
    plot.title = element_text(size = 13),
    axis.text.x = element_text(size = 13),
    axis.title.y = element_text(size = 13),
...
p5 <- structure_plot(
  ...
  guides(fill=guide_legend(title="Factor", ncol=1)) +
  guides(colour = "none") +
  ggtitle("Standard NMF Cell Scores \u2014 Treatment Associated Factors") +
  theme(
    plot.title = element_text(size = 14),
    axis.text.x = element_text(size = 13),
    axis.title.y = element_text(size = 13),
...
ggsave(
  "~/Documents/log1pNMF/inst/paper_figures/images/lsa_structure_celltype_rqe.png",
  g1,
  device = "png",
  width = 11,
  height = 7
...
ggsave(
  "~/Documents/log1pNMF/inst/paper_figures/images/lsa_structure_treatment_rqe.png",
  g2,
  device = "png",
  width = 11,
  height = 7
...
ggsave(
  "~/Documents/log1pNMF/inst/paper_figures/images/lsa_structure_treatment2_rqe.png",
  g3,
  device = "png",
  width = 11,
  height = 7
