...
fit_factor_model_log1p_exact_cpp_src <- function(sc_x, sc_i, sc_j, sc_T_x, sc_T_i, sc_T_j, s, U_T, V_T, n, p, max_iter, alpha, beta, num_ccd_iter, update_indices, fit_constant, tol) {
    .Call(`_passPCA_fit_factor_model_log1p_exact_cpp_src`, sc_x, sc_i, sc_j, sc_T_x, sc_T_i, sc_T_j, s, U_T, V_T, n, p, max_iter, alpha, beta, num_ccd_iter, update_indices, fit_constant, tol)
}
